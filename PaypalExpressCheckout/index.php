            ...
            <form class="form" action="paypal_ec_redirect.php" method="POST">
               <div class="row-fluid">
                  ...
                  <div class="span6 inner-span">
                        ...
                        <tr><td>Quantity:</td><td><input type="text" name="L_PAYMENTREQUEST_0_QTY0" value="1" ></input></td></tr>
                        <tr><td>Price:</td><td><input type="text" name="PAYMENTREQUEST_0_ITEMAMT" value="10.00" ></input></td></tr>
                        ...
                        <tr><td>Total Amount:</td><td><input type="text" name="PAYMENTREQUEST_0_AMT" value="17" ></input></td></tr>
