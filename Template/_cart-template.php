                            ...
                            <div class="col-sm-2 text-right">
                                <div class="font-size-20 text-danger font-baloo">
                                    $<span class="product_price"
                                           data-id="<?php echo $item['item_id'] ?? '0'; ?>"><?php echo $format_number_1 = number_format($item['item_price']); ?></span>
                                </div>
                            </div>
                        </div>
                        <!-- !cart item -->
                ...
                <div class="sub-total border text-center mt-2">
                    ...
                    <form action="http://localhost/demo/Template/vn_pay/thanh-toan.php" method="post">
                        ...
                        <input class="form-control" id="amount" name="amount" type="number"
                               value="<?php echo isset($subTotal) ? $Cart->getSum($subTotal) :''; ?>" readonly/>
