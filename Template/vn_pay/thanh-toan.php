        ...
        <div class="container">
            ...
            <div class="table-responsive">
                ...
                <div class="form-group">
                        <label for="order_desc">Địa chỉ nhận hàng</label>
                        <textarea class="form-control" cols="20" id="order_desc" name="order_desc" rows="2">334 Nguyễn Trãi - Quận Thanh Xuân - Hà Nội</textarea>
                    </div>
                    <div class="form-group">
                        <label for="language">Loại hàng hóa </label>
                        <input class="form-control" id="order_type" name="order_type" type="text" value="Điện thoại"/>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="form-control" cols="20" id="order_desc" name="order_desc" rows="2">Online payment</textarea>
                    </div>
                    <div class="form-group">
